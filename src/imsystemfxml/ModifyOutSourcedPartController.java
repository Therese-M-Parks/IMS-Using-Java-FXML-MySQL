 ...
 */
public class ModifyOutSourcedPartController extends MainScreenController implements Initializable {

    @FXML
    private Label modifyPartLabel;

    @FXML
    private ToggleGroup modOutPart;
    ...
    @FXML // controls for outSourced label radio button
    void ModifyOutSourcedPart(ActionEvent event) throws IOException {
        ...
        String coName = coNameField.getText();
        String price = priceField.getText();
        // Create a new Part out of the information pulled from the Add Screen
        Part newPart = new OutSourcedPart(0, name, Double.parseDouble(price), Integer.parseInt(inv), Integer.parseInt(min), Integer.parseInt(max), coName);
        String message = "";
        boolean valid = true;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        coNameField.setText(((OutSourcedPart) MainScreenController.selectedPart).getCompanyName());
    }
